...
static OPCODE_TABLE: &[(Opcode, &str)] = &[
    ...
    (Opcode::Jump,            "jmp"),
    (Opcode::JumpGreater,     "jmpg"),
    (Opcode::JumpEqual,       "jmpe"),
    (Opcode::JumpSmaller,     "jmps"),
    (Opcode::JumpGreaterEqual,"jmpge"),
    (Opcode::JumpNotEqual,    "jmpne"),
    (Opcode::JumpSmallerEqual,"jmpse"),
    (Opcode::Branch,            "b"),
